...
/**
 *  Divertsy can use Bluetooth beacons for gathering physical location information.
 *  This is disabled by default in settings. See MainActivity for permission checks.
 */
public class Beacon {
    ...
    public class UrlStatus {
        ...
        @Nullable
        public Uri getUrl() {
            return urlValue != null ? Uri.parse(urlValue) : null;
        }
    }
